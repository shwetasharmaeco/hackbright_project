    ...
    render() {
        ...
        return (
            <div id="user_listings">
                ...
                <div id="user_listing_container" className="px-4">
                            ...
                            <ul style={{listStyle: "none"}}>
                                <li key={listing.listing_id} style={{ textAlign: 'center', borderBottom: "1px solid black" }}>
                                    ...
                                    <div className="row" style={{ justifyContent: "center", display: "flex" , alignItems: "center"}}>
                                        ...
                                        <button className="btn-sm col-1" type="submit" value="order" onClick={this.handleupdate.bind(this, listing)} style={{ margin: "0.5rem", backgroundColor: "#e2bd19" }}> Update</button>
                                    </div>
                                </li>
                            </ul>
